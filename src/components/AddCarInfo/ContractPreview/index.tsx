				...
				<Row>
					...
					<Col xl={19} md={19} sm={24} xs={24} className={styles.backgroundGray}>
						...
						<div className={`${styles.dashBody} ${styles.spacingTop}`}>
							<Row gutter={16} align={'middle'}>
								<Col xl={7} md={6} sm={24} xs={24}></Col>
								<Col xl={10} md={12} sm={24} xs={24}>
									<Titles level={3} className={`alignCenter ${styles.marginNone}`}>
										Contract Preview
									</Titles>
									<center>
									...
									<br />
									<div className="cardPart alignCenter">
										<ShowImage src="/images/Mask-group.png" alt="Mask Images" size="large" />
									</div>
									<br />
