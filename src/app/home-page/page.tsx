  ...
  return (
    ...
    <div  className={styles.bannerPart}>
     ...
     <Row align="middle" gutter={16}>
        <Col lg={10} md={10} sm={10} xs={10}>  
          <Titles level={1} color='light'> Flexible.  Affordable.  <span className='yellowText'>Home</span></Titles>
          <br/>
          <Titles level={5} color='light' className='weight400'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</Titles>
        </Col> 
      </Row>
      <div  className={styles.bookYourVacation}>
       <ParaText size="medium" color='light' className={styles.bookYour}  > Book your vacation</ParaText>
       <Row align="middle" gutter={16}>
        <Col lg={19} md={19} sm={19} xs={24}>   
          ...
          <Row align="middle" gutter={16}>
            ...
            <Col lg={4} md={4} sm={4} xs={12}>ax</Col>
            <Col lg={3} md={3} sm={3} xs={12}>ax</Col>
            <Col lg={8} md={8} sm={8} xs={24}>axa</Col>
          </Row>
          </div>
        </Col>
        <Col lg={5} md={5} sm={5} xs={24} className='textEnd'>
         <SecondaryButton label='Find A Room' className={`mediumButton w100 ${styles.SubscribeButton}`}/>
        </Col> 
      </Row>
      </div>
   ...
   <div className='about mainGap'>
    ...
    <div className={`mainGap ${styles.faqPart}`} >
      <div className="mainContainer">
      <Titles level={3} color='neutralColor' className='textCenter'> Frequently Asked Questions</Titles> <br/><br/>
        <CollapsePanel/>
      </div>
    </div>
